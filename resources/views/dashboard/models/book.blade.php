<div class="modal fase " id="all_booking" data-backdrop="static" data-keyboard="false" tabindex="-1"
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
                ...
                <table class="table table-striped table-bordered zero-configuration">
                    ...
                    <tbody>
                      @if(auth()->user()->hasRole('Admin'))
                        ...
                        @php
                            $companies = App\Booking::orderBy('id', 'DESC')->take(10)->get();
                        @endphp
                        @else
                        @php
                            $companies = App\Booking::where('copmany_id',auth()->user()->company->id)->orderBy('id', 'DESC')->take(10)->get();
                        @endphp
                        @endif
        ...
        <div class="modal-footer">
            <a href="{{ route('booking.get_all_booking') }}" class="btn btn-info">
                @lang('Show All')
            </a>
        </div>
