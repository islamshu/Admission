<div class="modal fase " id="all_booking_progress" data-backdrop="static" data-keyboard="false" tabindex="-1"
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
                ...
                <table class="table table-striped table-bordered zero-configuration">
                    ...
                    <tbody>
                      @if(auth()->user()->hasRole('Admin'))
                        ...
                        @php
                            $companies = App\Booking::where('status',2)->orderBy('id', 'DESC')->take(10)->get();
                        @endphp
                        @else
                        @php
        ...
        <div class="modal-footer">
            <a href="{{ route('booking.get_all_booking',['status'=>2]) }}" class="btn btn-info">
                @lang('Show All')
            </a>
        </div>
