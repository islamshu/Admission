    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">@lang('Privacy policy Page')</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">@lang('Home')</a>
                            </li>
                            <li class="breadcrumb-item active">@lang('Privacy policy Page')
                            </li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">@lang('Privacy policy Page')</h4>
                                    ...
                                    <tr data-id="{{ $item->id }}">
                                        ...
                                        <td>
                                            ...
                                            <form method="post" style="display: inline"
                                                action="{{ route('privacy.delete', $item->id) }}">
                                                @csrf @method('delete')
                        ...
                        <form class="form" method="post" action="{{ route('privacy.store') }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title_ar" id="name_ar"
                                            class="form-control form-control-solid" placeholder="{{ __('Arabic Title') }}" required />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>{{ __('English Title') }} :</label>
                                        <input type="text" name="title_en" id="name_en"
                                            class="form-control form-control-solid" placeholder="{{ __('English Title') }}" required />
                                    </div>
                                    <div class="form-group col-md-6">
