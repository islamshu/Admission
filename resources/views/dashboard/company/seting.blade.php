                            ...
                            <form class="form" method="post" action="{{ route('company.setting') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6" id="in_all_comapny" @if(auth()->user()->company->is_same == 1) style="display:none" @else style="display:block" @endif >
                                            <div class="form-group">
                                                ...
                                                <select class="form-control border-primary" name="in_all_comapny">
                                                    ...
                                                    <option value="0" @if(auth()->user()->company->in_all_comapny == 1) selected @endif>@lang('no')</option>
