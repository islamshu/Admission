                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <select name="nationality_id" id="select_new" required class="form-control"  >
                                                    ...
                                                    <option value="{{ $item->id }}" @if(old('nationality_id') == $item->id) selected @endif>{{ $item->name }}</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="in_sa" required class="form-control"  >
                                                    <option value="1"  @if(old('in_sa') == 1) selected @endif  > Yes </option>
                                                    <option value="0"  @if(old('in_sa') == 0) selected @endif > No </option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="language" required class="form-control"  >
                                                    ...
                                                    @foreach (get_language() as $item)
                                                        <option value="{{ $item }}" @if(old('language') == $item) selected @endif> {{ $item }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="approve_chiled" required class="form-control"  >
                                                    <option value="1" @if(old('approve_chiled') == 1) selected @endif > Yes </option>
                                                    <option value="0" @if(old('approve_chiled') == 0) selected @endif> No </option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="is_coocked" required class="form-control"  >
                                                    <option value="1" @if(old('is_coocked') == 1) selected @endif> Yes </option>
                                                    <option value="0" @if(old('is_coocked') == 0) selected @endif> No </option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="is_quick" required class="form-control" id="time_q" >
                                                    ...
                                                    <option value="1" @if(old('is_quick') == 1) selected @endif> immediately </option>
                                                    <option value="0" @if(old('is_quick') == 0 &&  old('is_quick') != null ) selected @endif> needs time </option>
