              ...
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <form class="form-horizontal form-simple" method="post" action="{{ route('process_login') }}" novalidate>
                        @csrf
                      <fieldset class="form-group position-relative has-icon-left mb-0">
                        <input type="text" class="form-control form-control-lg input-lg" name="phone" id="user-name" placeholder="Your Phone"
                        required>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-12  text-md-right"><a href="{{ route('register_company') }}" class="card-link">Create Acount  </a></div>
                      </div>
