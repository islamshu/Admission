...
data-open="click" data-menu="vertical-content-menu" data-col="1-column">
              ...
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <div class="alert alert-success" role="alert" id="successMsgRegister" style="display: none" >
                        {{ __('the otp send to your phone') }} 
                       </div>
                       <div class="alert alert-success" role="alert" id="successMsgOtp" style="display: none" >
                        {{ __('The data will be verified by the administration and we will contact you!') }} 
                       </div>
                    <form class="form-horizontal form-simple" id="SubmitForm">
                        @csrf
                        
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" name="name" value="{{ old('name') }}" id="InputName" placeholder="Your name"
                            required>
                          ...
                          <br>
                          <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="email" class="form-control form-control-lg input-lg" name="email" value="{{ old('email') }}" id="InputEmail" placeholder="Your Email"
                            required>
                            <div class="form-control-position">
                              <i class="ft-user"></i>
                            </div>
                          ...
                          <br>
                      <fieldset class="form-group position-relative has-icon-left mb-0">
                        <input type="text" class="form-control form-control-lg input-lg" name="phone" value="{{ old('phone') }}" id="InputPhone" placeholder="Your Phone"
                        required>
                        <div class="form-control-position">
                          <i class="ft-user"></i>
                        </div>
                      ...
                      <br>
                      <fieldset class="form-group position-relative has-icon-left mb-0">
                        <input type="text" class="form-control form-control-lg input-lg" name="commercial_register" value="{{ old('commercial_register') }}" id="InputCommical" placeholder="Your commercial register"
                        required>
                        <div class="form-control-position">
                          <i class="ft-user"></i>
                        </div>
                        <span class="text-danger" id="commicalErrorMsg"></span>
                    ...
                    <form class="form-horizontal form-simple" id="check_otp" style="display: none">
                        ...
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" name="otp" value="{{ old('otp') }}" id="otp" placeholder="OTP"
                            required>
                            <div class="form-control-position">
                              <i class="ft-user"></i>
                            </div>
                      ...
                      <button type="submit" class="btn btn-info btn-lg btn-block"><i class="ft-unlock"></i> Check</button>
                    </form>
                  </div>
                </div>
  ...
  <script>
    $('#SubmitForm').on('submit', function(e) {
        ...
        let commical = $('#InputCommical').val();
        ...
        $.ajax({
            ...
            data: {
                ...
                email: email,
                phone: mobile,
                commercial_register: commical,
            },
            success: function(response) {
                $('#successMsgRegister').show();
                $('#InputName').val('');
                $('#InputEmail').val('');
                $('#InputPhone').val('');
                $('#InputCommical').val('');
